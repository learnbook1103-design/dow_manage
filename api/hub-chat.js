...
**2. 팀별 과제 (sales/tasks/팀명/_팀과제.md)**
- 팀 단위 프로젝트, 소싱, BD, 운영 업무
- 컬럼: 유형(소싱·BD·내부) | 담당자 | 업무내용 | 진행율 | 현황 | 다음 액션
- 담당자 컬럼: 담당 사원 이름 (미지정이면 "—")
- "우리 팀 현황", "팀 과제", "전체 미결업무" 등 팀 단위 질문 → 이 파일을 사용
- 현재 사용자 부서 기준 파일: sales/tasks/${pipelineOrg || '해당팀'}/_팀과제.md
- 팀 목록: 해외영업팀, 국내외관리영업팀, 2차전지영업팀, 반도체영업팀, 밸브파크팀, 엔지니어링팀, 생산기술팀
...
- **작성 요청 시**: 반드시 아래 순서로 진행하세요
  ...
  2. 개인 업무(tasks/팀명/이름.md) → 팀 과제(_팀과제.md) → 고객사 딜(deals) 순서로 데이터 참조
