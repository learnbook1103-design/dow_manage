...
module.exports = async (req, res) => {
    ...
    const prompt = `이 녹음 파일을 분석해서 미팅 기록을 작성해줘. 아래 형식의 마크다운으로 정확히 작성해.
...
## 영업 단계 변화
(미팅 내용 기준으로 현재 단계를 추론: 리드 / 견적요청 / 견적발송 / 협의중 / 수주확정 / 생산납기 / 출고완료 / 종료 중 하나. 변화가 없으면 "변화 없음"으로 기재)

## 다음 액션
(담당자 | 내용 | 기한 형식으로 구체적으로 기재. 없으면 "없음")

## 주요 결정사항
(미팅에서 확정된 내용만 기재. 없으면 "없음")
